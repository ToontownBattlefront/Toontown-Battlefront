...
class _CleverbotSession(ChatterBotSession):
    ...
    def think_thought(self, thought):
        ...
        self.vars['ttcyLocMP3'] = _utils_string_at_index(response_values, 13)
        self.vars['ttcyLocTXT'] = _utils_string_at_index(response_values, 14)
        self.vars['ttcyLocTXT3'] = _utils_string_at_index(response_values, 15)
        self.vars['ttcyText'] = _utils_string_at_index(response_values, 16)
